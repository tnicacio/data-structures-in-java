...
public class Lista {
    ...
    public void insereOrdenado(Object v) {
        NoLista ant = null;
        NoLista novo;
        NoLista p = prim;
    ...
    public NoLista[] buscaComAnterior(Object v) {
    ...
    public boolean insereEm(int posicao, Object v) {
        NoLista novo = new NoLista();
        novo.setInfo(v);
        NoLista ult;
        int tam = comprimento();
    ...
    public void insereFim(int valor) {
        ...
        if (ult != null && ult.getInfo() != null && ult.getProx() == null) {
            ult.setProx(novo);
        }
    }
    ...
    public NoLista ultimoNoV (int v){
        ...
        while (p != null){
            if(p.getInfo() != null && v == (int) p.getInfo()){
                ultimoValor = p;     
            }
            p = p.getProx();
        }
